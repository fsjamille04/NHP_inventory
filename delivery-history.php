...
$table_data = $conn->query("SELECT * FROM delivery ORDER BY DateSpecific");
    	...
    	<section class="sidebar"> 
	      <!-- Sidebar user panel (optional) -->
	      	...
	      	<ul class="sidebar-menu">
		        ...
		        <li class="active"><a href="delivery-history.php"><i class="fa fa-home"></i> <span>Delivery History</span></a></li>  
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content"> 
            ...
            <div class="modal-footer">
            	<input type="hidden" value="delivery" id="db_table">
			...
			success: function(data){
				...
				if(data == 'true'){
					swal({
						...
						// Redirect the user
						window.location.href = "delivery-history.php"; 
					});
				}else{
					swal({
						title: "Error",
