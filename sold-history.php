...
$table_data = $conn->query("SELECT * FROM sold ORDER BY DateSpecific DESC");
    	...
    	<section class="sidebar"> 
	      <!-- Sidebar user panel (optional) -->
	      	...
	      	<ul class="sidebar-menu">
		        ...
		        <li class="active"><a href="sold-history.php"><i class="fa fa-home"></i> <span>Sold History</span></a></li> 
	      	</ul>
      <!-- /.sidebar-menu -->
		</section>
    <!-- /.sidebar -->
    ...
    <div class="modal-dialog modal-md">
        <div class="modal-content"> 
            ...
            <div class="modal-footer">
            	<input type="hidden" value="sold" id="db_table">
